  ...
  const getAllSessions = async () => {
    try {
      ...
      const { data } = await axiosInstance.get(
        ...
        }/api/class/getAllClasses?page=${currentPage}&limit=5&searchQuery=${searchQuery}`,
      );
  ...
  return (
    <div className="mt-12 mb-8 flex flex-col gap-12">
      ...
      <Card>
        <CardHeader
          variant="gradient"
          className="mb-8 p-6 flex flex-col md:flex-row justify-between items-center bg-secondary"
        >
          <Typography variant="h6" className="text-dark mb-4 md:mb-0">
            All Sessions
          </Typography>
          <div>
            <div class=" relative mx-auto mb-4 md:mb-0 ">
              <input
